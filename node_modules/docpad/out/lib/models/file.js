...
FileModel = (function(_super) {
  ...
  FileModel.prototype.normalize = function(opts, next) {
    var basename, changes, contentType, date, escapedRelativePath, extension, extensions, filename, fullDirPath, fullPath, meta, mtime, name, outContentType, outDirPath, outExtension, outFilename, outPath, relativeBase, relativeDirPath, relativeOutDirPath, relativeOutPath, relativePath, slug, url, _ref2;
    if (opts == null) {
      opts = {};
    }
    _ref2 = this.getActionArgs(opts, next), opts = _ref2.opts, next = _ref2.next;
    ...
    if (this.outDirPath && relativePath && (relativeDirPath != null)) {
