...
DocPad = (function(_super) {
  ...
  */
  ...
  DocPad.prototype.initNodeModule = function(name, opts) {
  ...
  DocPad.prototype.loadFiles = function(opts, next) {
    var collection, config, database, docpad, locale, slowFilesObject, slowFilesTimer, tasks, _ref1;
    if (opts == null) {
      opts = {};
    }
    docpad = this;
  ...
  DocPad.prototype.contextualizeFiles = function(opts, next) {
    var collection, config, docpad, locale, slowFilesObject, slowFilesTimer, tasks, templateData, _ref1;
    if (opts == null) {
      opts = {};
    }
    docpad = this;
  ...
  DocPad.prototype.renderFiles = function(opts, next) {
    var collection, config, docpad, initialCollection, locale, renderCollection, renderFile, renderPasses, slowFilesObject, slowFilesTimer, subsequentCollection, tasks, templateData, _i, _results,
      _this = this;
    if (opts == null) {
      opts = {};
    }
